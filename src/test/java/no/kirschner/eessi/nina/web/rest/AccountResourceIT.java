package no.kirschner.eessi.nina.web.rest;

import static no.kirschner.eessi.nina.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import no.kirschner.eessi.nina.JhipsterSampleApplicationApp;
import no.kirschner.eessi.nina.config.Constants;
...
import no.kirschner.eessi.nina.repository.AuthorityRepository;
import no.kirschner.eessi.nina.repository.PersistentTokenRepository;
import no.kirschner.eessi.nina.repository.UserRepository;
import no.kirschner.eessi.nina.security.AuthoritiesConstants;
import no.kirschner.eessi.nina.service.UserService;
import no.kirschner.eessi.nina.service.dto.PasswordChangeDTO;
import no.kirschner.eessi.nina.service.dto.UserDTO;
import no.kirschner.eessi.nina.web.rest.vm.KeyAndPasswordVM;
import no.kirschner.eessi.nina.web.rest.vm.ManagedUserVM;
